...
export const leadContent = {
  ...
  paragraph: `${schoolName} designs its coding bootcamp to prepare students for a career in web development. ${schoolName} partners with Skills Fund to offer tuition${
