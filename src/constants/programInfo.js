import logo from "../images/logo_launch.png" // add school logo to images folder and import here
...
export const faq = { // faq section
    ...
    loanRange: [
        {
            programName: "the Boston On-Campus Bootcamp",
            maxAmount: "$16,500",
            col: true,
            colAmount: "$6,000"
        }
...
export const schoolName = "Launch Academy"

export const schoolURL = 'https://launchacademy.com/' // update with url of school's website

export const skfURL = 'https://launchacademy.skills.fund' // update with Skills Fund url

export const headline = "Learn to Code at Launch Academy" // update headline as appropriate

export const leadContent = {
    header: "Your last step on the path toward changing your career",
    paragraph: `${schoolName} designs its coding bootcamp to prepare students for a career in web development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const threeStepCardText = {
    ...
    step2: {
        ...
        text: "Launch Academy focuses exclusively on its coding bootcamp."
    },
    step3: `You'll be on your way to an exciting career in tech as part of ${schoolName}'s powerful network.`
}

export const netlifyFormName = 'launchacademy_contact'

export const GATracking = 'UA-68312423-1'

export const hubspotFormId = "c2bdb5d8-27b5-48f2-9d55-289eaa3e5e97" // create Hubspot form, get form id after publishing
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        ...
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKLWD18",
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $16,500 for tuition, and up to an additional $6,000 for cost of living."
